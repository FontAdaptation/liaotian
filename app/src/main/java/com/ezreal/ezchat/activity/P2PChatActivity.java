...
import com.ezreal.ezchat.audiorecordbutton.AudioPlayManager;
...
import com.ezreal.ezchat.photoselector.PhotoSelectActivity;
...
public class P2PChatActivity extends BaseActivity
    ...
    /*** 播放音频，并监听播放进度，更新页面动画，initMsgList中调用 ***/
    ...
    /*** 根据消息附件内容，跳转至相应界面显示附件，initMsgList中调用**/
    ...
    /******** 页面跳转回调 ********/
    //下面photoBtnClick和locationBtnClick startActivityForResult用到
